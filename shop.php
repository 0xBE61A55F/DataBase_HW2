...
if(isset($_POST["submit"]) && $_POST["submit"] == "register"){
	...
	if($BID == "" || $ShopName == "" || $ShopCategory == "" || $Latitude == "" || $Longitude == "")  
	{  
		echo "<script>alert('請不要留空！'); history.go(-1);</script>";  
	}	

	$sql = "insert into business values('$BID','$ShopName','$ShopCategory','$Latitude','$Longitude');";
...
<form action='shop.php' method='post' name='form'>
        <div class="form-group ">
          <div class="row">
	    <div class="col-xs-2">
              <label for="ex5">BID</label>
              <input class="form-control" id="B" name="B"  placeholder="" type="text" >
            </div>
            <div class="col-xs-2">
              <label for="ex5">shop name</label>
              <input class="form-control" id="ShopName" name="ShopName"  placeholder="macdonald" type="text" >
            </div>
            <div class="col-xs-2">
              <label for="ex5">shop category</label>
              <input class="form-control" id="ShopCategory" name="ShopCategory"  placeholder="fast food" type="text" >
            </div>
            <div class="col-xs-2">
              <label for="ex6">latitude</label>
              <input class="form-control" id="Latitude" name="Latitude"  placeholder="121.00028167648875" type="text" >
            </div>
            <div class="col-xs-2">
              <label for="ex8">longitude</label>
              <input class="form-control" id="Longitude" name="Longitude"  placeholder="121.00028167648875" type="text" >
            </div>
          </div>
        </div>
